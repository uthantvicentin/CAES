...
def process(args_):
    ...
    for filename in files:
      resul = abs(np.fft.fft(pd.read_csv(path_ + filename, header=None, 
                                         delimiter=',')))
      
      pos = ''
    
      if filename[len(filename)-6] == '1':
          pos = '10'
      elif filename[len(filename)-6] == '2':
          pos = '100'
      elif filename[len(filename)-6] == '3':
          pos = '1.000'
      elif filename[len(filename)-6] == '4':
          pos = '10.000'
      elif filename[len(filename)-6] == '5':
          pos = '100.000'
      elif filename[len(filename)-6] == '6':
          pos = '1.000.000'
      else:
          pos = '10.000.000'
...
if __name__ == "__main__":
    ...
    np.savetxt(fname="resultados/data_300.csv", X=data, fmt="%.15f", delimiter=",")
